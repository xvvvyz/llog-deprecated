drop index if exists "public"."notifications_read_created_at_index";
...
create index notifications_archived_created_at_index on public.notifications using btree (archived, created_at desc);

...
create index inputs_team_id_deleted_updated_at_index on public.inputs using btree (team_id, deleted, updated_at);
...
create index missions_subject_id_deleted_updated_at_index on public.missions using btree (subject_id, deleted, updated_at);
...
create index subjects_team_id_deleted_updated_at_index on public.subjects using btree (team_id, deleted, updated_at);
...
alter table "public"."comments" add constraint "comments_content_length" check (((length(content) > 0) and (length(content) < 5000))) not valid;
...
alter table "public"."comments" add constraint "comments_profile_id_fkey" foreign key (profile_id) references profiles (id) not valid;
...
alter table "public"."event_type_inputs" add constraint "event_type_inputs_event_type_id_fkey" foreign key (event_type_id) references event_types (id) not valid;
alter table "public"."event_type_inputs" add constraint "event_type_inputs_input_id_fkey" foreign key (input_id) references inputs (id) not valid;
alter table "public"."event_type_inputs" add constraint "event_type_inputs_pkey" primary key using index "event_type_inputs_pkey";
...
alter table "public"."event_types" add constraint "event_types_content_length" check (((length(content) > 0) and (length(content) < 5000))) not valid;
alter table "public"."event_types" add constraint "event_types_mission_id_fkey" foreign key (mission_id) references missions (id) not valid;
alter table "public"."event_types" add constraint "event_types_name_length" check (((length(name) > 0) and (length(name) < 50))) not valid;
alter table "public"."event_types" add constraint "event_types_pkey" primary key using index "event_types_pkey";
alter table "public"."event_types" add constraint "event_types_subject_id_fkey" foreign key (subject_id) references subjects (id) not valid;
...
alter table "public"."event_inputs" add constraint "event_inputs_event_id_fkey" foreign key (event_id) references events (id) not valid;
alter table "public"."event_inputs" add constraint "event_inputs_input_id_fkey" foreign key (input_id) references inputs (id) not valid;
alter table "public"."event_inputs" add constraint "event_inputs_input_option_id_fkey" foreign key (input_option_id) references input_options (id) not valid;
alter table "public"."event_inputs" add constraint "event_inputs_pkey" primary key using index "event_inputs_pkey";
...
alter table "public"."events" add constraint "events_event_type_id_fkey" foreign key (event_type_id) references event_types (id) not valid;
alter table "public"."events" add constraint "events_pkey" primary key using index "events_pkey";
alter table "public"."events" add constraint "events_subject_id_fkey" foreign key (subject_id) references subjects (id) not valid;
...
alter table "public"."input_options" add constraint "input_options_input_id_fkey" foreign key (input_id) references inputs (id) not valid;
alter table "public"."input_options" add constraint "input_options_label_length" check (((length(label) > 0) and (length(label) < 50))) not valid;
alter table "public"."input_options" add constraint "input_options_pkey" primary key using index "input_options_pkey";
...
alter table "public"."inputs" add constraint "inputs_label_length" check (((length(label) > 0) and (length(label) < 50))) not valid;
alter table "public"."inputs" add constraint "inputs_pkey" primary key using index "inputs_pkey";
alter table "public"."inputs" add constraint "inputs_team_id_fkey" foreign key (team_id) references teams (id) not valid;
...
alter table "public"."missions" add constraint "missions_name_length" check (((length(name) > 0) and (length(name) < 50))) not valid;
alter table "public"."missions" add constraint "missions_pkey" primary key using index "missions_pkey";
alter table "public"."missions" add constraint "missions_subject_id_fkey" foreign key (subject_id) references subjects (id) not valid;
...
alter table "public"."profiles" add constraint "profiles_first_name_length" check (((length(first_name) > 0) and (length(first_name) < 50))) not valid;
alter table "public"."profiles" add constraint "profiles_id_fkey" foreign key (id) references auth.users (id) not valid;
alter table "public"."profiles" add constraint "profiles_last_name_length" check (((length(last_name) > 0) and (length(last_name) < 50))) not valid;
...
alter table "public"."subject_managers" add constraint "subject_managers_pkey" primary key using index "subject_managers_pkey";
alter table "public"."subject_managers" add constraint "subject_managers_profile_id_fkey" foreign key (profile_id) references profiles (id) not valid;
alter table "public"."subject_managers" add constraint "subject_managers_subject_id_fkey" foreign key (subject_id) references subjects (id) not valid;
...
alter table "public"."subjects" add constraint "subjects_image_uri_length" check ((length(image_uri) < 100)) not valid;
alter table "public"."subjects" add constraint "subjects_name_length" check (((length(name) > 0) and (length(name) < 50))) not valid;
alter table "public"."subjects" add constraint "subjects_pkey" primary key using index "subjects_pkey";
alter table "public"."subjects" add constraint "subjects_team_id_fkey" foreign key (team_id) references teams (id) not valid;
...
alter table "public"."team_members" add constraint "team_members_profile_id_fkey" foreign key (profile_id) references profiles (id) not valid;
...
alter table "public"."teams" add constraint "teams_name_length" check (((length(name) > 0) and (length(name) < 50))) not valid;
alter table "public"."teams" add constraint "teams_owner_fkey" foreign key (owner) references profiles (id) not valid;
...
alter table "public"."templates" add constraint "templates_name_length" check (((length(name) > 0) and (length(name) < 50))) not valid;
alter table "public"."templates" add constraint "templates_pkey" primary key using index "templates_pkey";
alter table "public"."templates" add constraint "templates_team_id_fkey" foreign key (team_id) references teams (id) not valid;
...
create or replace function public.handle_insert_or_update_object ()
  ...
  as $$
  begin
    if (storage.filename (new.name) = 'avatar') then
...
create or replace function public.handle_insert_team ()
  ...
  as $$
  begin
    insert into public.team_members (team_id, profile_id) values (new.id, new.owner);
    return new;
  end;
  $$;
